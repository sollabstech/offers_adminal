...
export default function NewProductPage() {
  ...
  const { addProduct, vendors } = useAdminStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const product: Product = {
      ...
      vendorName: isOfferss ? "Offerss.com" : (vendor?.name ?? ""),
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4">
          ...
          <div>
            ...
            <input required value={form.name} onChange={(e) => set("name", e.target.value)}
              className="input-field" placeholder="e.g. iPhone 15 Pro Max" />
          </div>
          ...
          <div>
            ...
            <input value={form.tags} onChange={(e) => set("tags", e.target.value)}
              className="input-field" placeholder="e.g. apple, smartphone, flagship" />
          </div>
